...
class Delogo:
    ...
    def auto_delogo(self, clip, dlg):
        ...
        clip_e_y = core.std.ShufflePlanes(clip_e_a, 0, vs.GRAY)
        clip_e_u = core.std.ShufflePlanes(clip_e_a, 1, vs.GRAY)
        clip_e_v = core.std.ShufflePlanes(clip_e_a, 2, vs.GRAY)
        ...
        dlg_e_y = core.std.ShufflePlanes(dlg_e_a, 0, vs.GRAY)
        dlg_e_u = core.std.ShufflePlanes(dlg_e_a, 1, vs.GRAY)
        dlg_e_v = core.std.ShufflePlanes(dlg_e_a, 2, vs.GRAY)
        ...
        wlogo = core.std.ShufflePlanes(wlogo, 0, vs.GRAY)
